        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    max_discount = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_promo_rule_site", x => x.id);
                    table.ForeignKey(
                        name: "FK_promo_rule_site_promo_rule_promo_rule_id",
                        column: x => x.promo_rule_id,
                        principalTable: "promo_rule",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("302be9cd-5e08-454d-b8e5-582d336750d7"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3634), 1, "ITEM", "ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3646) },
                    { new Guid("8713bd36-48d6-43dd-94b9-407c3aff1528"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3651), 2, "CART", "CART", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3652) },
                    { new Guid("c386c5f1-d3d2-4e7f-ad6a-34b4f185325c"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3656), 4, "Entertain", "Entertain", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3657) },
                    { new Guid("dbf358cb-f43b-4d69-9176-8ee63ac8953f"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3654), 3, "MOP", "MOP", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3654) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1f57489b-cca0-4392-ae00-3d145012d375"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3910), 2, "302BE9CD-5E08-454D-B8E5-582D336750D7", "AMOUNT", "DISCOUNT AMOUNT ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3910) },
                    { new Guid("2524251a-565a-46c0-93d5-deea80c63ff5"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3920), 2, "8713BD36-48D6-43DD-94B9-407C3AFF1528", "PERCENT", "DISCOUNT PERCENT CART", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3921) },
                    { new Guid("3c7ed57d-8235-453f-8f97-ba93b3747b4f"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3923), 2, "DBF358CB-F43B-4D69-9176-8EE63AC8953F", "AMOUNT", "DISCOUNT AMOUNT MOP", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3923) },
                    { new Guid("57ae0d50-1d3b-4a33-8d7c-a4cab863aa30"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3929), 2, "C386C5F1-D3D2-4E7F-AD6A-34B4F185325C", "PERCENT", "DISCOUNT PERCENT Entertain", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3930) },
                    { new Guid("86ed449a-e4bc-4c28-a6e5-3ba18e491e63"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3918), 2, "8713BD36-48D6-43DD-94B9-407C3AFF1528", "AMOUNT", "DISCOUNT AMOUNT CART", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3918) },
                    { new Guid("886470d3-5e0b-41ed-baa7-10cd94511e10"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3913), 2, "302BE9CD-5E08-454D-B8E5-582D336750D7", "PERCENT", "DISCOUNT PERCENT ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3913) },
                    { new Guid("bd4f0c46-7d03-45fa-b33c-77028218593a"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3915), 2, "302BE9CD-5E08-454D-B8E5-582D336750D7", "BUNDLE", "DISCOUNT BUNDLING ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3916) },
                    { new Guid("dda43968-95bd-4d94-8737-fd621d0a5895"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3925), 2, "DBF358CB-F43B-4D69-9176-8EE63AC8953F", "PERCENT", "DISCOUNT PERCENT MOP", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3926) },
                    { new Guid("e0d70f81-6a25-434d-9055-e50554ef585c"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3906), 1, "302BE9CD-5E08-454D-B8E5-582D336750D7", "SP", "SPECIAL PRICE ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3907) },
                    { new Guid("fac8e236-2fb7-4b4a-b644-0680f60fd0a0"), true, "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3902), 1, "302BE9CD-5E08-454D-B8E5-582D336750D7", "ITEM", "BUY X GET Y ITEM", "System", new DateTime(2023, 11, 18, 21, 6, 48, 155, DateTimeKind.Local).AddTicks(3903) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_promo_rule_site_promo_rule_id",
                table: "promo_rule_site",
                column: "promo_rule_id");
